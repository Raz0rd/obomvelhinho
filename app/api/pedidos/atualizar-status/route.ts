    ...
    if (status === 'PAID') {
      ...
      try {
        ...
        if (pedido) {
          ...
          // NOTA: Evento PAID para Utmify é enviado diretamente no PixPayment.tsx
          // quando o pagamento é confirmado, para evitar duplicação
          console.log('ℹ️ [ATUALIZAR-STATUS] Evento Utmify PAID já foi enviado pelo PixPayment');
        } else {
