    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            Ótimas notícias! Seu pagamento foi confirmado com sucesso e seu pedido já está sendo processado. 🎄
          </Text>

          {/* Box de Destaque */}
          <Section style={statusBox}>
            <Text style={statusTitle}>Status do Pedido</Text>
            <div style={statusSteps}>
              ...
              <div style={stepPending}>
                ...
                <Text style={stepLabel}>⏳ Em Processamento</Text>
              </div>
              <div style={stepPending}>
                <Text style={stepNumber}>3</Text>
                <Text style={stepLabel}>📦 Preparando Envio</Text>
              </div>
              <div style={stepPending}>
                <Text style={stepNumber}>4</Text>
                <Text style={stepLabel}>🚚 A Caminho</Text>
              </div>
            </div>
          </Section>
